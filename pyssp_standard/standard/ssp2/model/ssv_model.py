...
class Ssp2Parameter:
    ...
    dimensions: list[Ssp2Dimension] = field(default_factory=list)


@dataclass
class Ssp2ParameterSet:
    name: str
    version: str
    metadata: Ssp1DocumentMetadata = field(default_factory=Ssp1DocumentMetadata)
    parameters: list[Ssp2Parameter] = field(default_factory=list)

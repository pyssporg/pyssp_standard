...
OUTPUT_PATH = HERE / "ssd_generated_types.py"
...
def generate_bindings(
    ...
    with tempfile.TemporaryDirectory(prefix="xsdata_demo_ssd_") as tmp_dir:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Regenerate demo SSD xsdata bindings from XSD.")
    parser.add_argument("--schema", type=Path, default=SCHEMA_PATH, help="Path to the SSD schema root.")
    parser.add_argument(
        "--output",
        type=Path,
        default=OUTPUT_PATH,

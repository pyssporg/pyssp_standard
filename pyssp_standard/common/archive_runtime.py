...
class ArchiveRuntime:
    ...
    def __exit__(self, exc_type, exc, tb):
        try:
            ...
            self._directory_runtime.__exit__(exc_type, exc, tb)
    ...
    def read_text(self, name: str, encoding: str = "utf-8") -> str:
        return self._directory_runtime.read_text(name, encoding=encoding)

    def add_file(self, source: str | Path, target_name: str | None = None) -> str:
        return self._directory_runtime.add_file(source, target_name=target_name)

    def remove_file(self, target_name: str) -> None:
        self._directory_runtime.remove_file(target_name)
